...
namespace Unscode\Galleries\Providers;
...
class GalleriesServiceProvider extends ServiceProvider
{
    ...
    protected function setRoutes()
    {
        if (!$this->app->routesAreCached()) {
            $this->app->router->group(['namespace' => 'Unscode\Galleries\Http\Controllers'],
                function () {
    ...
    {
        $this->loadViewsFrom(__DIR__ . '/../resources/views', 'unscode/galleries');
    }
